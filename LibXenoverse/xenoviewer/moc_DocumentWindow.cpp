...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DocumentWindow_t, stringdata) + ofs \
...
const QMetaObject DocumentWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_DocumentWindow.data,
      qt_meta_data_DocumentWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DocumentWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DocumentWindow.stringdata))
